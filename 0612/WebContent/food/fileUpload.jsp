...
<body>
 <%
        //이미지를 저장할 경로 입력.
        String path = "C:\\Users\\user\\eclipse-workspace\\0612\\WebContent\\images";
        ...
        int foodPrice = Integer.parseInt(multi.getParameter("foodPrice"));
        double foodKcal = Double.parseDouble(multi.getParameter("foodKcal"));
        Food food = new Food(foodName,foodType,foodPrice,foodKcal,fileName, new java.util.Date());//파라미터 생성자를 이용하여 속이 꽉 찬 pet을 만듦
        Connection conn = ConnectionProvider.getConnection();//insert하기 위해서 커넥션 만듦
        try{//트라이캐치문
        	FoodDao dao = new FoodDao();//Dao만듦
        	dao.insert(conn, food);//dao.insert해주기
        }catch(SQLException e){}
    %>
음식정보를 입력하였습니다. <a href = "list.jsp">리스트보기</a>
</body>
</html>